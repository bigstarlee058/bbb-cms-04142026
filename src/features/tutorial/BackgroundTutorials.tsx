...
// import { UpdateTutorials } from './UpdateTutorials';

// export const BackgroundTutorials = () => {
//   const { addNotification } = useNotificationStore();
//   const { data, isLoading, error } = useQuery('get-tutorials', fetchTutorials, {
...
//           <UpdateTutorials screenData={data[0]} />
//         </div>
//       </div>
...
//             <Vimeo className="h-full w-full" video={data[0].vimeoId} autoplay={false} />
//           </div>
//         </div>
//       </ContentLayout>
...
//               <h3 className="text-md font-semibold text-gray-800 mb-2">{data[0].title}</h3>
